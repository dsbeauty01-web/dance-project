...
class Config:
    ...
    model_answer: str = E("MAYA_MODEL_ANSWER", "gpt-4.1-mini")
...
class Brain:
    def __init__(self, cfg: Config, catalog: Catalog, mem: Memory, meter: CostMeter, leads: Callable[[ChatEvent, str], None]):
        ...
        if pf and os.path.exists(pf):
            # persona file replaces the character block; the hard RULES + JSON contract are always appended
            rules = PERSONA[PERSONA.index("RULES (hard):"):]
