...
(async () => {
  ...
  await pg.waitForTimeout(9000); await pg.screenshot({ path: require('path').join(__dirname,'shot-hero-a.png'), clip:{x:0,y:0,width:800,height:900} }); await pg.waitForTimeout(8000);
  await pg.screenshot({ path: path.join(__dirname, 'shot-hero-b.png'), clip: { x: 0, y: 0, width: 800, height: 900 } });
